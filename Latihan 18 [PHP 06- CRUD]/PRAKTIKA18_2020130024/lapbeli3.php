...
<?php  
   ...
   // → Kode Pemasok/ Nama Pemasok/ No Bon/ Tgl Beli/ 
   // → Nama Bahan/ Harga/ Banyak/ Sub Total

   $tgl_awal  = $_GET['tg_aw'];
   $tgl_akhir = $_GET['tg_ak'];

   require('Koneksi.php');
   $sql = "select   P.kdpemasok, nama, B.nobon, tglbeli,
                    namabahan,harga,banyak,harga*banyak as subtotal 
